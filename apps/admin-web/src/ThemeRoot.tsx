...
import { PromotionDateTimeConformance } from './PromotionDateTimeConformance';
...
function CurrentSurface() {
  ...
  if (window.location.pathname === '/conformance/datetime') {
    return <PromotionDateTimeConformance />;
  }
  return <App />;
}
